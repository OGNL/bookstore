	...
	function _go() {
		...
		if(!/^[1-9]\d*$/.test(pc)) {//对当前页码进行整数校验
			...
			alert('最大${maxpage}页！');
				...
				document.getElementById("form").action = "${pageContext.request.contextPath}/book/showbysome.action?page="+pc;
				document.getElementById("form").submit();
			}
		}
	}
	function gopage(page){
		document.getElementById("form").action = "${pageContext.request.contextPath}/book/showbysome.action?page="+page;
		document.getElementById("form").submit();
	}
</script>
