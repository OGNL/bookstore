...
<style type="text/css">
  ...
  <body>
    <h3>添加2级分类</h3>
    <h1></h1>
    <form id="form" action="${pageContext.request.contextPath}/category/doaddII.action" method="post">
    	<input type="hidden" name="pid" value="${category.cid}">
    	一级分类：<input type="text" value="${category.cname}" readonly="readonly"><br/>
    	分类名称：<input type="text" name="cname" id="cname"/><br/>
    	分类描述：<textarea rows="5" cols="50" name="description" id="desc"></textarea><br/>
    	<input type="button" value="添加二级分类" onclick="addBtn()"/>
