...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/order/pay.css">
...
function dopay(){
	alert("支付成功！");
	location.href = "${pageContext.request.contextPath}/order/doupdate.action?id=${order.oid}&status=2";  		
}
</script>
  </head>
...
<div class="divContent">
	<span class="spanPrice">֧支付金额：</span><span class="price_t">&yen;${order.total}</span>
...
<div class="divBank">
	...
	<div style="margin: 40px;">
		<a href="javascript:;" class="linkNext" onclick="dopay()">下一步</a>
	</div>
</div>
</form>
  </body>
